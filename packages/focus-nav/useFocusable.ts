...
export interface UseFocusableConfig<P = object> {
  ...
  /**
   * Marks the component as a focus container.
   * Focus containers have special focus recovery and redirection logic.
   */
  focusContainer?: boolean;
  /**
   * Simulates click on the component `onEnter`.
   * Enables the usage of regular `onClick/onPress`
   */
